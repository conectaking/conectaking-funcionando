...
-- Selecione TODO o conteúdo (Ctrl+A) e execute (Ctrl+Enter)
-- ===========================================

-- PASSO 1: Criar a tabela profile_tabs
...
-- PASSO 5: Criar trigger (SÓ DEPOIS que a tabela foi criada no PASSO 1)
