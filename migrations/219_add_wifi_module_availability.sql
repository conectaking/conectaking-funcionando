-- ===========================================
-- Migration 219 (parte 2): CHECK profile_items + module_plan_availability
-- Corre depois de 219_add_wifi_module.sql (enum já com 'wifi' commitado).
-- ===========================================

-- 1) Recriar CHECK de profile_items alinhada ao enum (igual 144/168)
DO $$
DECLARE
    col RECORD;
    labels_sql TEXT;
...
-- 2) Disponibilidade em module_plan_availability
DO $$
DECLARE
...
SELECT 'Migration 219 (parte 2): CHECK + module_plan_availability para wifi.' AS status;
