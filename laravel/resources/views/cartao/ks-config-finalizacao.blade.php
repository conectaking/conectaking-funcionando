...
<head>
  ...
  <style>
    :root {
      --ks-primary: #facc15;
      --ks-black: #0a0a0a;
      --ks-card: rgba(18, 18, 18, 0.95);
      --ks-line: rgba(255, 255, 255, 0.12);
      --ks-muted: rgba(255, 255, 255, 0.5);
      --ks-text: #ffffff;
    }
    * { box-sizing: border-box; }
    ...
    .ks-back:hover { color: var(--ks-primary); }
    .ks-sub {
      color: var(--ks-muted);
      font-size: 0.875rem;
      margin-bottom: 8px;
    }
    .ks-sub strong { color: rgba(255,255,255,0.9); }
    .ks-hint {
      color: var(--ks-muted);
      font-size: 0.875rem;
      line-height: 1.5;
    ...
    .ks-msg.hidden { display: none !important; }
    .ks-msg.ok {
    ...
    .ks-field:last-of-type { margin-bottom: 0; }
    .ks-label {
      display: block;
      font-size: 0.75rem;
      font-weight: 700;
    ...
    .ks-textarea { min-height: 120px; resize: vertical; }
    .ks-input::placeholder, .ks-textarea::placeholder { color: var(--ks-muted); }
    .ks-input:focus, .ks-textarea:focus {
      outline: none;
    ...
    .ks-btn:disabled { opacity: 0.7; cursor: not-allowed; }
    .ks-btn-primary {
    ...
    .ks-btn-wrap { display: flex; gap: 10px; flex-wrap: wrap; margin-top: 10px; }
  </style>
</head>
<body>
  <div class="ks-wrap">
    ...
    <div class="ks-card">
      <form id="formFinalizacao">
        <div class="ks-field">
          ...
          <p class="ks-hint" style="margin-top:6px;margin-bottom:0;">Esse nome substitui <code>@{{nome}}</code> na mensagem. Se não preencher, a plataforma usa o nome do seu perfil (cartão virtual).</p>
        </div>
        <div class="ks-field">
        ...
        <div class="ks-field">
          ...
          <p class="ks-hint" style="margin-top:6px;margin-bottom:0;">Use <code>@{{nome_cliente}}</code>, <code>@{{nome}}</code> e <code>@{{quantidade}}</code> onde quiser; serão trocados automaticamente. Em branco = mensagem padrão para todos.</p>
        </div>
        <div class="ks-field">
          <label class="ks-label">Logo / imagem de destaque (opcional)</label>
          <p class="ks-hint" style="margin-bottom:8px;">Imagem que aparece na tela de obrigado (ex.: sua logo). Envie um arquivo do seu computador.</p>
        ...
        <button type="submit" id="btnSalvar" class="ks-btn ks-btn-primary" style="margin-top: 8px;">Salvar mensagem de finalização</button>
      </form>
    </div>
  </div>
