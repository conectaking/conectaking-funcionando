...
<head>
    ...
    <link rel="stylesheet" href="dashboard.css?v=2025-01-31-01">
    <style>
...
<body>
    ...
    <script>
        (function () {
            var API_URL = window.API_BASE || window.API_URL || (typeof localStorage !== 'undefined' && (localStorage.getItem('apiBase') || localStorage.getItem('API_BASE'))) || 'https://www.conectaking.com.br';
