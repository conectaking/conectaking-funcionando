 ...
 * Vite: definir window.__CK_RECIBOS_NAV_ACTIVE antes do import.
 * Legado: <script src="js/recibos-modulo-nav.js" data-active="...">
 */
(function () {
    var script = document.currentScript;
    var bodyActive = document.body && document.body.getAttribute('data-recibos-nav');
    var active = bodyActive
        || (typeof window !== 'undefined' && window.__CK_RECIBOS_NAV_ACTIVE)
        || (script && script.getAttribute('data-active'))
        || 'painel';
