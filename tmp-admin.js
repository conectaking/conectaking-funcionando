...
function renderUsers(users) {
    ...
    users.forEach((u, index) => {
        ...
        row.innerHTML = `
            ...
            <td data-label="Tipo de Conta" data-col="account_type" class="account-type-cell" style="cursor: pointer; user-select: none;" data-user-id="${u.id}" data-user-email="${u.email}" data-account-type="${u.account_type}" data-is-admin="${u.is_admin}" data-subscription-status="${u.subscription_status || ''}" data-expires-at="${u.subscription_expires_at || ''}" data-max-team-invites="${u.max_team_invites}">${accountTypeBadges[u.account_type] || u.account_type}</td>
...
if (deleteUserBtn) {
    ...
    if (createManualCodeBtn) {
        ...
        if (customCode.length > 12 || customCode.includes(' ')) {
