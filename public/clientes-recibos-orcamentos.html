...
<aside class="recibos-sidebar-desktop fixed left-0 top-0 h-full w-20 bg-white dark:bg-card-dark border-r border-slate-200 dark:border-border-dark hidden lg:flex flex-col items-center py-8 z-50">
    ...
    <div class="flex flex-col gap-6 mt-6">
        <a href="clientes-recibos-orcamentos.html" class="flex flex-col items-center gap-1 text-primary">
            <span class="material-icons-outlined">people</span>
            <span class="text-[10px] font-semibold uppercase">Clientes</span>
        </a>
        <a href="./configuracoes-recibos-orcamentos.html" class="flex flex-col items-center gap-1 text-slate-400 hover:text-primary transition-colors">
...
<main class="recibos-main-content ml-0 lg:ml-20 p-4 sm:p-6 lg:p-12 max-w-full">
    <div class="max-w-4xl mx-auto w-full">
        ...
        <p class="mt-6 text-slate-500 text-sm">No <a href="dashboard-recibos-orcamentos.html" class="text-primary font-medium hover:underline">painel</a>, escolha <a href="dashboard-recibos-orcamentos.html?abrir=recibo" class="text-primary font-medium hover:underline">Recibo</a> ou <a href="dashboard-recibos-orcamentos.html?abrir=orcamento" class="text-primary font-medium hover:underline">Orçamento</a> para criar novo ou continuar um existente. Ao editar, digite o nome do cliente para buscar na lista.</p>
    </div>
</main>
<script>
(function() {
