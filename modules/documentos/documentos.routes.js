...
router.post('/:id/nota-fiscal', uploadImage.single('image'), asyncHandler(controller.uploadNotaFiscalItem));
router.delete('/:id/nota-fiscal', asyncHandler(controller.removeNotaFiscalItem));
