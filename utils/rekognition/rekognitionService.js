...
function getRekogConfig() {
  ...
  /** CompareFaces (galeria sob demanda): padrão 68 para melhorar recall em eventos com luz/ângulo difíceis. */
  const compareSimilarityThreshold = Math.min(
    100,
    Math.max(50, parseInt(process.env.REKOG_COMPARE_SIMILARITY_THRESHOLD || '68', 10) || 68)
  );
  /**
