...
O sistema **Naya** é um mecanismo de auto-treinamento autônomo que permite que a IA aprenda automaticamente quando não souber responder uma pergunta. Ele pesquisa na internet, em livros/documentos e salva o conhecimento aprendido automaticamente no banco de dados.
...
2. **Sistema Naya é ativado automaticamente**:
...
1. **`ia_knowledge_base`**
   ...
   - `source_type`: `naya_book_document`, `naya_book_book`, `naya_web_tavily`
...
- `🧠 [NAYA] Sistema de auto-treinamento ativado para: [pergunta]`
- `📖 [NAYA] Buscando em livros e documentos...`
- `🌐 [NAYA] Pesquisando na internet...`
- `✅ [NAYA] Encontrou conhecimento em livro/documento: [título]`
- `✅ [NAYA] Resposta encontrada na internet (Tavily direto)`
- `💾 [NAYA] Conhecimento salvo automaticamente na base de dados!`
...
2. Naya é ativado automaticamente
...
2. Naya detecta pergunta religiosa
...
2. Naya detecta pergunta histórica
...
- Função principal: `autoTrainNaya(question, questionContext, client)`
...
**Desenvolvido para tornar a IA Naya verdadeiramente autônoma e autossustentável! 🚀**
