-- ===========================================
-- MIGRATION SALES PAGES - VERSÃO SIMPLES PARA DBEAVER
-- Execute este script completo de uma vez (Ctrl+A, depois Ctrl+Enter)
-- ===========================================

-- PASSO 1: Criar ENUMs (execute mesmo se der erro de "já existe")
...
-- IMPORTANTE: Se der erro "cannot be executed inside a transaction block", 
-- execute este comando separadamente em uma nova aba SQL
ALTER TYPE item_type_enum ADD VALUE IF NOT EXISTS 'sales_page';

-- PASSO 3: Criar tabela sales_pages
...
-- PASSO 4: Criar tabela sales_page_products
...
-- PASSO 5: Criar tabela sales_page_events
...
-- PASSO 7: Criar função para trigger updated_at
...
-- PASSO 8: Criar trigger para sales_pages
...
-- PASSO 9: Criar função para trigger updated_at produtos
...
-- PASSO 10: Criar trigger para sales_page_products
...
-- ===========================================
-- VERIFICAÇÃO: Execute esta query DEPOIS para confirmar
-- ===========================================
