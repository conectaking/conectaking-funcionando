...
-- COMANDO 1: Criar ENUM sales_page_status (ignora se já existe)
DO $$ BEGIN
...
-- COMANDO 2: Criar ENUM product_status (ignora se já existe)
DO $$ BEGIN
...
-- COMANDO 3: Criar ENUM event_type (ignora se já existe)
DO $$ BEGIN
...
-- COMANDO 5: Criar tabela sales_pages (ignora se já existe)
...
-- COMANDO 6: Criar tabela sales_page_products (ignora se já existe)
...
-- COMANDO 7: Criar tabela sales_page_events (ignora se já existe)
...
-- COMANDO 8: Criar índices para sales_pages (ignora se já existe)
...
-- COMANDO 9: Criar índices para sales_page_products (ignora se já existe)
...
-- COMANDO 10: Criar índices para sales_page_events (ignora se já existe)
...
-- COMANDO 11: Criar função para trigger sales_pages
...
-- COMANDO 12: Criar trigger para sales_pages (ignora se já existe)
...
-- COMANDO 13: Criar função para trigger products
...
-- COMANDO 14: Criar trigger para sales_page_products (ignora se já existe)
