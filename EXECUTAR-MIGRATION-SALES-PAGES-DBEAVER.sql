...
-- 1. Abra o dBeaver
-- 2. Conecte-se ao banco de dados PostgreSQL do projeto
...
-- Por isso, vamos executar cada comando separadamente

-- ===========================================
-- PASSO 1: Criar ENUMs
-- ===========================================

-- Criar ENUM sales_page_status
DO $$ 
BEGIN
...
-- ===========================================
-- PASSO 2: Adicionar sales_page ao ENUM item_type_enum
-- ===========================================
...
-- Função para atualizar updated_at em sales_pages
...
-- Função para atualizar updated_at em sales_page_products
...
-- Trigger para sales_page_products
...
WHERE table_name IN ('sales_pages', 'sales_page_products', 'sales_page_events')
